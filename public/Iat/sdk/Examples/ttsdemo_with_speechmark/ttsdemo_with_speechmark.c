...
int main(int argc, char* argv[])
{
	...
	const char*  filename = "text_to_speech_test_withspeechmark.pcm";
	const char* param = "aue = speex-wb;3, vcn=xiaoyan, spd = 50, vol = 50, tte = utf8, smk=3";//带参数smk=3，获取详细的语音标注，json格式，请自行解析
	int ret = 0;
	char key = 0;
